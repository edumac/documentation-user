...
then the mandate keeps being *Active* until it is *Closed* or *Revoked*.
...
made after the present day won’t be processed with an SDD payment.
...
**XML files** with all SDD payment instructions can be uploaded to your bank institution to process
...
Select all the payments in the list that you want to include in your SDD XML file, then click on
*Action* and select *Create Batch Payment*.
...
Finally, upload this file to your bank institution to process the payments.
